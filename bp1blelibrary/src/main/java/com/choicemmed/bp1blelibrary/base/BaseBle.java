...
public abstract class BaseBle
    ...
    public void startLeScan() {
        ...
        if (!this.bleHandler.hasMessages(0)) {
    ...
    public void connectDevice(String address) {
        ...
        if (this.mBluetoothGatt != null) {
            ...
            try {
                ...
                Log.d("BLELog", "开始连接……" + this.mBluetoothDevice);
                this.mBluetoothGatt = this.mBluetoothDevice.connectGatt(this.mContext, true, GetGattCallback());
