...
public class CdocLoadingDots extends LinearLayout {
    ...
    public CdocLoadingDots(Context context) {
        super(context);
        init(null);
    }

    public CdocLoadingDots(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CdocLoadingDots(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CdocLoadingDots(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
