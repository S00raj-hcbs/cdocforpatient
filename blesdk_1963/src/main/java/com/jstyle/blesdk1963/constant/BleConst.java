...
public class BleConst {
   ...
   public static final String HealthStatusColorSwitchOnMainInterfaceWithMode="63";
   public static final String GetHealthStatusColorSwitchOnMainInterfaceWithMode="64";
   public static final String HealthStatusAlertPushWithStatus="65";
   public static final String GetHealthStatusAlertPushWithStatus="66";
